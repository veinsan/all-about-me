...
\chapter{Selamat Datang di Ruang Refleksi
Diri}\label{selamat-datang-di-ruang-refleksi-diri}

\bookmarksetup{startatroot}

\chapter{Hello World! 👋}\label{hello-world}

\section{Saya {[}Nama Kamu{]}}\label{saya-nama-kamu}

Selamat datang di ruang refleksi diri dan perjalanan pembelajaran saya
pada mata kuliah \textbf{Komunikasi Interpersonal}.\\
Website ini dibuat sebagai portofolio digital untuk menunjukkan
pemahaman saya terhadap berbagai konsep komunikasi --- mulai dari
bagaimana kita berinteraksi, memahami diri, menafsirkan realitas, hingga
menyampaikan pesan tanpa kata.

Tujuannya bukan hanya untuk memenuhi tugas, tetapi juga untuk
mengevaluasi diri: sejauh mana saya mampu menerapkan prinsip komunikasi
yang efektif, beretika, dan berlandaskan nilai-nilai kemanusiaan.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsection{Yuk Kenalan!}\label{yuk-kenalan}

Klik tombol di bawah ini untuk menjelajahi tiap bagian perjalanan saya:

Tentang Saya UTS 1 UTS 2 UTS 3 UTS 4
